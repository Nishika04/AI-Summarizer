    ...
    py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
            <div className="w-full justify-center flex">
                ...
                to-rose-800 animate-gradient-x group">
                    <Badge 
                    variant={'secondary'}
                    className="relative px-6 py-2 text-base font-medium g-white rounded-full group-hover:bg-gray-50
            ...
            px-4 lg:px-0 lg:max-w-4xl text-gray-600 mx-auto">
                Get a beautiful summary reel of the document in seconds.
            </h2>
            <div className="flex justify-center">
            <Button variant ={'link'} 
            className="text-white mt-6 text-base sm:text-lg lg:text-xl
            rounded-full px-8 sm:px-10 lg:px-12 py-6
            sm-py-7 lg:py-8 lg-mt-16 bg-linear-to-r from-slate-900 to-rose-500
